				...
				return (
					...
					(t.prototype.focusNextItem = function (t) {
						if (this.haveResults) {
							...
							0 === s.length &&
								(s = t
									? this._dd.find("li").last()
									: this._dd.find("li").first()),
					...
					Object.defineProperty(t.prototype, "isItemFocused", {
						get: function () {
							return !!(
								this.isShown() && this._dd.find("li.active").length > 0
							);
						},
						enumerable: !1,
						configurable: !0,
					...
					(t.prototype.showMatchedText = function (t, e) {
						...
						if (s > -1) {
							var i = s + e.length;
							return (
								t.slice(0, s) + "<b>" + t.slice(s, i) + "</b>" + t.slice(i)
							);
						}
						return t;
					}),
						...
						if (this.items.length > 0)
							this.items.forEach(function (s) {
								var i,
									o,
									n = t.formatItem(s);
								"string" == typeof n && (n = { text: n }),
									(i = t.showMatchedText(n.text, t.searchText)),
									(o = void 0 !== n.html ? n.html : i);
								var r = n.disabled,
									l = $("<li >");
								l.append($("<a>").attr("href", "#!").html(o)).data("item", s),
									r && l.addClass("disabled"),
									e.push(l);
							});
						else {
							var s = $("<li >");
							s
								.append($("<a>").attr("href", "#!").html(this.noResultsText))
								.addClass("disabled"),
								e.push(s);
						}
						this._dd.append(e);
				...
				return (
					...
					(t.prototype.focusNextItem = function (t) {
						if (this.haveResults) {
							...
							0 === s.length &&
								(s = t
									? this._dd.find(".dropdown-item").last()
									: this._dd.find(".dropdown-item").first()),
								e.removeClass("active"),
								s.addClass("active");
						}
					}),
					...
					Object.defineProperty(t.prototype, "isItemFocused", {
						get: function () {
							return !!(
								this._dd &&
								this.isShown() &&
								this._dd.find(".dropdown-item.active").length > 0
							);
						},
						enumerable: !1,
						configurable: !0,
					...
					(t.prototype.refreshItemList = function () {
						...
						if (this.items.length > 0)
							...
							var s = $("<a >");
							s.addClass("dropdown-item disabled").html(this.noResultsText),
								e.push(s),
								this._dd.append(e),
								this.show();
						}
			...
			a = (function () {
				function t(t, e) {
					(this._selectedItem = null),
						...
						"object" == typeof e &&
							(this._settings = $.extend(!0, {}, this.getSettings(), e)),
				...
				return (
					(t.prototype.manageInlineDataAttributes = function () {
						...
						this._$el.data("url") &&
							(t.resolverSettings.url = this._$el.data("url")),
							this._$el.data("default-value") &&
								(this._defaultValue = this._$el.data("default-value")),
							this._$el.data("default-text") &&
								(this._defaultText = this._$el.data("default-text")),
							void 0 !== this._$el.data("noresults-text") &&
								(t.noResultsText = this._$el.data("noresults-text"));
					}),
					...
					(t.prototype.getBootstrapVersion = function () {
						...
						"auto" === this._settings.bootstrapVersion
							...
							? (t = [3])
							: (console.error(
									"INVALID value for 'bootstrapVersion' settings property: " +
										this._settings.bootstrapVersion +
										" defaulting to 4"
							  ),
							  (t = [4]));
						return t;
					...
					(t.prototype.convertSelectToText = function () {
						var e = $("<input>");
						e.attr("type", "hidden"),
							e.attr("name", this._$el.attr("name")),
							this._defaultValue && e.val(this._defaultValue),
							(this._selectHiddenField = e),
							e.insertAfter(this._$el);
						var s = $("<input>");
						s.attr("type", "search"),
						...
						i && s.attr("required", i),
							s.data(t.NAME, this),
							this._$el.replaceWith(s),
							(this._$el = s),
							(this._el = s.get(0));
					}),
					(t.prototype.init = function () {
						this.bindDefaultEventListeners(),
							"ajax" === this._settings.resolver &&
								(this.resolver = new n(this._settings.resolverSettings)),
							4 === this.getBootstrapVersion()[0]
								? (this._dd = new l(
										this._$el,
										this._settings.formatResult,
										this._settings.autoSelect,
										this._settings.noResultsText
								  ))
								: (this._dd = new r(
										this._$el,
										this._settings.formatResult,
							...
							switch (e.which) {
								case 9:
									t._dd.isItemFocused
										...
										: t._selectedItem ||
										  ("" !== t._$el.val() &&
												t._$el.trigger("autocomplete.freevalue", t._$el.val())),
										t._dd.hide();
									break;
								case 13:
									t._dd.isItemFocused
									...
									: t._dd.isMouseOver ||
									  (t._isSelectElement
											? t._dd.isItemFocused
												...
												? (t._$el.val(t._defaultText),
												  t._selectHiddenField.val(t._defaultValue),
												  (t._selectedItem = null),
												  t._$el.trigger(
														"autocomplete.select",
														t._selectedItem
												...
												: (t._$el.val(""),
												  t._selectHiddenField.val(""),
												  (t._selectedItem = null),
												  t._$el.trigger(
														"autocomplete.select",
														t._selectedItem
												  ))
											: null === t._selectedItem &&
											  t._$el.trigger("autocomplete.freevalue", t._$el.val()),
									  t._dd.hide());
							}),
					...
					(t.prototype.handlerTyped = function (t) {
						(null === this._settings.events.typed ||
							(t = this._settings.events.typed(t, this._$el))) &&
							(t.length >= this._settings.minLength
								? ((this._searchText = t), this.handlerPreSearch())
								: this._dd.hide());
					}),
					(t.prototype.handlerPreSearch = function () {
						if (null !== this._settings.events.searchPre) {
							var t = this._settings.events.searchPre(
								this._searchText,
								this._$el
							);
							if (!t) return;
					...
					(t.prototype.postSearchCallback = function (t) {
						(this._settings.events.searchPost &&
							"boolean" ==
								typeof (t = this._settings.events.searchPost(t, this._$el)) &&
							!t) ||
							this.handlerStartShow(t);
					}),
					...
					(t.prototype.itemSelectedDefaultHandler = function (t) {
						if (null != t) {
							...
							"string" == typeof e && (e = { text: e }),
								...
								this._isSelectElement && this._selectHiddenField.val(e.value);
						} else
							this._$el.val(""),
					...
					(t.prototype.manageAPI = function (t, e) {
						"set" === t
							? this.itemSelectedDefaultHandler(e)
							: "clear" === t
							? this.itemSelectedDefaultHandler(null)
							: "show" === t
							? this._$el.trigger("keyup")
							: "updateResolver" === t && (this.resolver = new n(e));
					}),
					(t.NAME = "autoComplete"),
					t
				);
		...
		!(function (t, e, s) {
			t.fn[a.NAME] = function (e, s) {
				return this.each(function () {
					var i;
					(i = t(this).data(a.NAME)) ||
						((i = new a(this, e)), t(this).data(a.NAME, i)),
						i.manageAPI(e, s);
				});
			};
